export function DataScience() {
  return (
    <section className="py-24 px-6 md:px-12 bg-white relative z-20 flex justify-center">
      <div className="max-w-6xl w-full bg-[#faf9f8] rounded-[3rem] py-24 px-8 md:px-20 text-center flex flex-col items-center justify-center">
