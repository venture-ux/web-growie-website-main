...
export function Portfolio() {
  ...
  return (
    <section id="portfolio" className="py-32 px-6 md:px-12 bg-white relative z-20">
          ...
          {portfolios.map((item, i) => (
             ...
             >
               <div className="absolute inset-0 w-full h-full">
                 <img src={item.img} alt={item.title} className="w-full h-full object-cover object-top transition-transform duration-700 group-hover:scale-105 opacity-90" />
               </div>
               {/* Label */}
